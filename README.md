# anixart.py
Mobile-API for [anixart](https://anixart.tv) mobile application that will help you get acquainted with a wide variety of Japanese animation works.
...
anixart.login(login="example@gmail.com", password="password")
```
